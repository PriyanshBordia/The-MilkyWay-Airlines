...
------------
   ...
   - You must have postgreSql installed locally. You can download ``postgreSql`` `here`_.

.. _download: https://www.python.org
   :target: _blank

.. _here: https://www.postgresql.org
   :target: _blank
...
.. note:: You must change the database in ``flights/settings.py``.
